...
class ForwardDeformer(torch.nn.Module):
    ...
    def __init__(self,model_type, d_out, **kwargs):
        super().__init__()
        
        self.softmax_mode = 'hierarchical'
        self.model_type = model_type
        
        self.lbs_network = ImplicitNetwork(d_in=3,d_out=d_out,multires=0, width=128, depth=5, dim_cond_embed=0,weight_norm=True, geometric_init=False)
