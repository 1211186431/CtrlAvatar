...
from lib.xavatar_scan_model_sdf import XAVATARSCANModel
...
def main(opt):
    ...
    logger = pl.loggers.WandbLogger(project='XAvatar_ours_base1', config=config)
