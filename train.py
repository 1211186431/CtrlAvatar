    ...
    for epoch in range(num_epochs):
        for i, data in enumerate(dataloader):
            ...
            if cond is None:
                ...
                pred_colors,pts_c = model(mesh_data['verts'],cond)
...
def main(config):
    ...
    mesh_data={'verts':verts,'faces':faces,'distances':distances,'idx':idx,'nn':nn,'val_img_dir':val_img_dir,'val_mesh_dir':val_mesh_dir,'model_save_dir':model_save_dir,'writer':writer}
